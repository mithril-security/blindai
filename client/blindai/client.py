...
from untrusted_pb2 import GetServerInfoRequest as server_info_request
...
class SignedResponse:
    ...
    def as_bytes(self):
        return ResponseProof(
            ...
            attestation=self.attestation.SerializeToString(),
        ).SerializeToString()
    ...
    def load_from_bytes(self, b: bytes):
        ...
        self.attestation = GetSgxQuoteWithCollateralReply.FromString(proof.attestation)
        self._load_payload()
